      ...
      <main className="relative max-w-5xl mx-auto px-6 py-12 sm:py-16 space-y-12">
        ...
        <header className="space-y-4 border-b border-zinc-800/80 pb-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="inline-flex items-center gap-2.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-medium tracking-wide uppercase">
            ...
            <Link
              href="/api/v1/health"
              target="_blank"
              className="text-xs font-mono text-zinc-400 hover:text-amber-400 transition-colors flex items-center gap-1.5"
            >
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-5 rounded-xl bg-zinc-900/70 border border-zinc-800 backdrop-blur-sm space-y-2">
            <div className="text-xs font-medium text-zinc-400 uppercase tracking-wider">Database Engine</div>
            <div className="flex items-center gap-2">
              <span className={`w-2.5 h-2.5 rounded-full ${dbConnected ? "bg-emerald-400 shadow-sm shadow-emerald-400/50" : "bg-rose-500"}`} />
          ...
          <div className="p-5 rounded-xl bg-zinc-900/70 border border-zinc-800 backdrop-blur-sm space-y-2">
            <div className="text-xs font-medium text-zinc-400 uppercase tracking-wider">Active Staff Seeded</div>
            <div className="text-2xl font-bold text-white">{barbers.length} Barbers</div>
          ...
          <div className="p-5 rounded-xl bg-zinc-900/70 border border-zinc-800 backdrop-blur-sm space-y-2">
            <div className="text-xs font-medium text-zinc-400 uppercase tracking-wider">Standard Services</div>
            <div className="text-2xl font-bold text-white">{services.length} Catalog Items</div>
            <p className="text-xs text-zinc-400">
              {services.map((s) => `${s.name} (₱${String(s.standardPrice)})`).join(", ") || "None seeded"}
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-white tracking-tight">Vertical Slice Implementation Roadmap</h2>
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="p-4 rounded-lg bg-emerald-950/20 border border-emerald-500/30 flex items-start gap-3.5">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-emerald-300">Slice 0: Walking Skeleton &amp; Environment Foundation</span>
                  <span className="text-[10px] font-medium bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded uppercase">Completed</span>
                </div>
                <p className="text-xs text-zinc-400">
            ...
            <div className="p-4 rounded-lg bg-zinc-900/60 border border-zinc-800 flex items-start gap-3.5">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-white">Slice 1: The Core Cut — Single Cash Haircut &amp; Offline Sync</span>
                  <span className="text-[10px] font-medium bg-amber-500/20 text-amber-300 px-2 py-0.5 rounded uppercase">Up Next</span>
                </div>
                <p className="text-xs text-zinc-400">
                  2-tap mobile POS checkout flow, Dexie.js IndexedDB client queue, client-side UUID generation, and idempotent Next.js sync endpoint (`POST /api/v1/transactions/sync`).
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-zinc-900/40 border border-zinc-800/60 flex items-start gap-3.5 opacity-75">
              ...
              <div className="space-y-1">
                <span className="text-sm font-semibold text-zinc-200">Slice 2: GCash &amp; Daily Cash Reconciliation (&quot;Abono&quot;)</span>
                <p className="text-xs text-zinc-400">
            ...
            <div className="p-4 rounded-lg bg-zinc-900/40 border border-zinc-800/60 flex items-start gap-3.5 opacity-75">
              ...
              <div className="space-y-1">
                <span className="text-sm font-semibold text-zinc-200">Slice 3: Barber 50/50 Commission &amp; Daily Shift Settlement</span>
                <p className="text-xs text-zinc-400">
            ...
            <div className="p-4 rounded-lg bg-zinc-900/40 border border-zinc-800/60 flex items-start gap-3.5 opacity-75">
              ...
              <div className="space-y-1">
                <span className="text-sm font-semibold text-zinc-200">Slice 4: Dynamic Catalog &amp; Staff Synchronization</span>
                <p className="text-xs text-zinc-400">
            ...
            <div className="p-4 rounded-lg bg-zinc-900/40 border border-zinc-800/60 flex items-start gap-3.5 opacity-75">
              ...
              <div className="space-y-1">
                <span className="text-sm font-semibold text-zinc-200">Slice 5: ML Revenue Forecasting Microservice &amp; Dashboard</span>
                <p className="text-xs text-zinc-400">
        ...
        <footer className="pt-6 border-t border-zinc-800/80 flex flex-wrap items-center justify-between gap-4 text-xs text-zinc-500">
          ...
          <div className="font-mono">Ruzzco Barbers System v0.1.0 (Slice 0)</div>
        </footer>
      </main>
    </div>
  );
